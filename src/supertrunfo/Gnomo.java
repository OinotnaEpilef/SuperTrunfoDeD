 ...
 *
 */
public class Gnomo implements Card {
	private int forca;
	...
	public void criar(String nomeJogador) {
		...
		int numDestreza = gerador.nextInt(2) + 15;
		int numCarisma = gerador.nextInt(2) + 12;
		int numForca = gerador.nextInt(3) + 8;
		this.forca = numForca;
